...
public class AgreementPL {
    ...
    public DeliveryTermsPL getDeliveryTerms() { return deliveryTerms; }
    public List<ProductLinePL> getProductLines() { return productLines; }
    public Map<Integer, List<DiscountBracketPL>> getDiscountPolicy() { return discountPolicy; }
}