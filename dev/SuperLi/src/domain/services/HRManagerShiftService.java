...
public class HRManagerShiftService {
    ...
    public void setJobsToShift(Shift shift, Map<Role, Integer> jobs) {
        ...
        shift.setRequiredJobs(jobs);
    }

 
    public java.util.List<String> placeToShifts(List<Employee> employees, List<Shift> shifts) {
    ...
    //helppwer function to convert Date to WeekDay Enum
